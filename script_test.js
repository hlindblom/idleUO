...
describe('Slice 2: Unlocking & Rendering Producers', function() {
  ...
  describe('The makeProducerDiv function', function() {
    ...
    it('returns a DOM element', function() {
      const result = code.makeProducerDiv(producer, data);
...
describe('Slice 3: Buying Producers & Tick', function() {
  describe('The getProducerById function', function() {
    ...
    beforeEach('initialize some fake data', function() {
      data = {
        producers: [
          { id: 'producer_A', basePrice: 50, price: 50 },
          { id: 'producer_B', basePrice: 50, price: 200 },
          { id: 'producer_C', basePrice: 50, price: 500 }
        ]
      };
    });
  ...
  describe('The updatePrice function', function() {
    const producer = { id: 'producer_A', basePrice: 50, price: 50, cps: 5, qty: 0 }
    const producer2 = { id: 'producer_A', basePrice: 501, price: 501, cps: 5, qty: 1 }
      
    it('returns an integer, not a float', function() {
      const result = code.updatePrice(producer);
      expect(result).to.be.a('number');
      expect(result % 1).to.be.equal(0);
    });
    it('returns 125% of the input price, rounded down', function() {
      const result = code.updatePrice(producer2);
  ...
  describe('The attemptToBuyProducer function', function() {
    ...
    beforeEach('initialize some fake data', function() {
      data = {
        ...
        totalCPS: 0,
        producers: [
          { id: 'producer_A', basePrice: 50, price: 50, cps: 5, qty: 0 },
          { id: 'producer_B', basePrice: 50, price: 200, cps: 10, qty: 0 },
          { id: 'producer_C', basePrice: 50, price: 500, cps: 20, qty: 0 }
        ]
      };
    });
  ...
  describe('The buyButtonClick function', function() {
    ...
    beforeEach('initialize some fake data', function() {
      data = {
        ...
        producers: [
          { id: 'producer_A', basePrice: 50, price: 50, cps: 5, qty: 0 },
          { id: 'producer_B', basePrice: 200, price: 200, cps: 10, qty: 0 },
          { id: 'producer_C', basePrice: 500, price: 500, cps: 20, qty: 0 }
        ]
      };
    });
